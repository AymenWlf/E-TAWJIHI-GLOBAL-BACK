...
#[ORM\Entity(repositoryClass: UserFinalStepStatusRepository::class)]
#[ORM\Table(name: 'user_final_step_status')]
class UserFinalStepStatus
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    #[ORM\ManyToOne(targetEntity: FinalStep::class)]
    #[ORM\JoinColumn(nullable: false)]
